...
neighborhoodFile = sc.textFile("airbnb_data/neighborhood2_test.csv") #get neighborhood test
listingFile = sc.textFile("airbnb_data/listings2_us.csv") #get filter
...
# Seattle
seattle_ray_casting = sc.textFile("Task6_data/neigh_s_w_id.csv") #seattle data with listings_id connected to neighborhoods
seattle_ray_casting2 = sc.textFile("Task6_data/neigh_seattle.csv") #seattle data with neighbourhood_groups instead of neighbourhood
...
#New York
new_york_ray_casting = sc.textFile("Task6_data/final_new_york.csv")
...
#San Francisco
san_francisco_ray_casting = sc.textFile("Task6_data/san_francisco.csv")
